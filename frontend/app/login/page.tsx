    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[60%] relative overflow-hidden flex-col justify-between p-12"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-6">
          ...
          <h2 className="text-[2.05rem] font-black text-white leading-[1.18] mb-5 tracking-tight">
            <span style={{
          ...
          <p className="text-slate-400 text-[0.9rem] max-w-sm leading-relaxed">
            Da DRE ao fluxo de caixa — informação financeira simplificada e processos
            automatizados para você decidir sem esperar o fechamento do mês.
          </p>
          ...
          <div className="mt-10 space-y-4">
            {[
              ...
              {
                label: "Importação automatizada de extratos e planilhas com mapeamento contábil",
                svg: (
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
              ...
              {
                label: "Insights e recomendações automáticos a partir dos seus números",
                svg: (
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
          ...
          <div className="mt-10 rounded-2xl p-6 backdrop-blur-sm relative overflow-hidden"
            ...
            <p className="text-slate-300 text-base font-medium leading-relaxed relative z-10 text-center">
              Informação financeira clara e processos automatizados —
          ...
          <form onSubmit={modoLogin ? handleLogin : handleSolicitarAcesso} className="space-y-4">
            ...
            {!modoLogin && (
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-1">Peça o nome ao administrador do seu escritório</p>
